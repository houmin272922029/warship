...
local AchievementRewardDialog = qy.class("AchievementRewardDialog", qy.tank.view.BaseDialog, "pubs.ui.AchievementRewardDialog")
...
function AchievementRewardDialog:createView()
    ...
    local function tableCellAtIndex(tableView, idx)
        ...
        if nil == cell then
            ...
            item = require("pubs.src.RewardItem").new({
