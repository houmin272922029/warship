...
name:setAnchorPoint(0.5, 0.5205)
name:setPosition(-5.8977, 247.5082)
name:setScaleX(1)
name:setScaleY(1)
name:setRotation(0)
...
layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(-77.8977)
layout:setRightMargin(-66.1023)
layout:setTopMargin(-260.4547)
layout:setBottomMargin(233.4547)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
