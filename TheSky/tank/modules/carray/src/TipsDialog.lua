local TipsDialog = qy.class("TipsDialog", qy.tank.view.BaseDialog, "carray.ui.TipsDialog")
...
function TipsDialog:addRichText(data)
    ...
    elseif data.type == 2 then
        if data.is_win then
            local info1 = self:makeText(qy.TextUtil:substitute(44041), cc.c3b(255, 255, 255))
            local plunder_nickname = self:makeText(data.plunder_nickname, cc.c3b(244, 30, 29))
            local info2 = self:makeText(qy.TextUtil:substitute(44042), cc.c3b(255, 255, 255))
