...
Img_1:loadTexture("daily_punch/res/222.png",0)
...
Btn_1:setPosition(139.9999, 31.5765)
Btn_1:setScaleX(1)
Btn_1:setScaleY(1)
Btn_1:setRotation(0)
...
layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(68.9999)
layout:setRightMargin(69.0001)
...
--Create Img_3
local Img_3 = cc.Sprite:create("daily_punch/res/lingqu.png")
Img_3:setName("Img_3")
...
Img_2:loadTexture("daily_punch/res/222.png",0)
...
--Create Img_4
local Img_4 = cc.Sprite:create("daily_punch/res/lingqu.png")
Img_4:setName("Img_4")
...
--Create Sprite_2
local Sprite_2 = cc.Sprite:create("daily_punch/res/2.png")
...
Text_title:setString([[每日累计充值100元可领取]])
