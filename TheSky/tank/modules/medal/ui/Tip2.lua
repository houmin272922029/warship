...
layout:setSize(cc.size(350, 100))
...
Text_1:setString([[当前勋章属性已满,已激活共鸣。
勋章属性增加60%。]])
...
Text_1:setColor(cc.c3b(208, 198, 198))
layout = ccui.LayoutComponent:bindLayoutComponent(Text_1)
layout:setPositionPercentXEnabled(false)
layout:setPositionPercentYEnabled(false)
layout:setPositionPercentX(0.0637)
