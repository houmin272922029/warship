...
list1:setString([[重铸出现紫色以上品质的属性，是否不保存
继续重铸？]])
...
list1:setPosition(258, 187.3099)
list1:setScaleX(1)
list1:setScaleY(1)
list1:setRotation(0)
...
layout:setSize(cc.size(418, 50))

layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(49)
layout:setRightMargin(43)
layout:setTopMargin(30.1151)
layout:setBottomMargin(159.8849)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
bg:addChild(list1)
