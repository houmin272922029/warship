...
BG:loadTexture("inter_service_escort/res/di13.png",1)
...
--Create Img
cc.SpriteFrameCache:getInstance():addSpriteFrames("inter_service_escort/res/res.plist")
local Img = cc.Sprite:createWithSpriteFrameName("inter_service_escort/res/shouhuo1.png")
Img:setName("Img")
...
layout:setPositionPercentXEnabled(false)
layout:setPositionPercentYEnabled(false)
layout:setPositionPercentX(0.077)
