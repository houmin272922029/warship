...
local tongzhi_2 = cc.Sprite:createWithSpriteFrameName("inter_service_escort/res/tongzhi.png")
...
Btn_ok:setPosition(230, 44.6264)
Btn_ok:setScaleX(1)
Btn_ok:setScaleY(1)
...
layout:setTopMargin(152.8736)
layout:setBottomMargin(12.1264)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
