...
local MainDialog = qy.class("MainDialog", qy.tank.view.BaseDialog, "pub.ui.MainDialog")
...
function MainDialog:ctor()
    ...
    self:OnClick("Btn_Reward", function()
        ...
        local dialog = require("pub.src.AchievementRewardDialog").new(self)
        dialog:show()
    ...
    for i, v in pairs(model.pubListPosition) do
    	...
    	item.name:setString("")
    	self["item" .. i] = item
        local sprite = cc.Sprite:createWithSpriteFrameName("pub/res/pub9.png")
...
function MainDialog:setFrame()
    ...
    self.Cheers:loadTexture("pub/res/" .. idx .. ".png", ccui.TextureResType.plistType)
end

-- 排名
function MainDialog:createRankView()
    local tableView = cc.TableView:create(cc.size(325, 300))
    ...
    local function tableCellAtIndex(tableView, idx)
        ...
        if nil == cell then
            ...
            item = require("pub.src.RankItem").new({
