...
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resources/common/button/common_button.plist")
closeBt:loadTextureDisabled("Resources/common/button/guanbi02.png",1)
...
closeBt:setPosition(711.009, 533.022)
closeBt:setScaleX(1)
closeBt:setScaleY(1)
...
if callBackProvider~=nil then
      closeBt:addClickEventListener(callBackProvider("LeaderboardDialog.lua", closeBt, "onDismiss"))
end
...
local paihangbang1_10 = cc.Sprite:createWithSpriteFrameName("Resources/common/title/ranking_title.png")
...
list:setPosition(23.5061, 35.9052)
list:setScaleX(1)
list:setScaleY(1)
list:setRotation(0)
...
layout:setPositionPercentY(0.0647)
layout:setPercentWidthEnabled(false)
layout:setPercentHeightEnabled(false)
layout:setPercentWidth(0.9387)
layout:setPercentHeight(0.7568)

layout:setSize(cc.size(720, 420))

layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(23.5061)
layout:setRightMargin(23.4939)
layout:setTopMargin(99.0948)
layout:setBottomMargin(35.9052)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
