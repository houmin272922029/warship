...
local backgroup = cc.Sprite:createWithSpriteFrameName("endless_war/res/1s.png")
...
backgroup:setPosition(361.4492, 70.172)
...
layout:setRightMargin(-717.4492)
...
layout:setSize(cc.size(103, 29))

layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(295)
layout:setRightMargin(-398)
...
--Create rank
local rank = cc.Sprite:create("endless_war/res/d.png")
rank:setName("rank")
...
layout:setSize(cc.size(53, 46))

layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(47.5)
layout:setRightMargin(-100.5)
layout:setTopMargin(-89.328)
layout:setBottomMargin(43.328)
