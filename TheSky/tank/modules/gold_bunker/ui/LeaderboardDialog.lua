...
local paihangbang1_10 = cc.Sprite:createWithSpriteFrameName("gold_bunker/res/paihangbang1.png")
...
update_time:setTextAreaSize(cc.size(0, 0))
update_time:setFontName("Resources/font/ttf/black_body_2.TTF")
update_time:setFontSize(22)
update_time:setString([[(每日0点更新)]])
update_time:setTextHorizontalAlignment(0)
update_time:setTextVerticalAlignment(0)
update_time:setTouchScaleChangeEnabled(false)
update_time:setFlippedX(false)
update_time:setFlippedY(false)
update_time:enableShadow(cc.c4b(0, 0, 0, 255), cc.size(1, -1), 0)
update_time:enableOutline(cc.c4b(0, 0, 0, 255), 1)
update_time:setTouchEnabled(false)
update_time:setLayoutComponentEnabled(true)
update_time:setName("update_time")
update_time:setLocalZOrder(0)
update_time:setTag(136)
update_time:setCascadeColorEnabled(true)
update_time:setCascadeOpacityEnabled(true)
update_time:setVisible(true)
update_time:setAnchorPoint(0, 0.5)
update_time:setPosition(231, 484.5)
update_time:setScaleX(1)
update_time:setScaleY(1)
update_time:setRotation(0)
update_time:setRotationSkewX(0)
update_time:setRotationSkewY(0)
update_time:setOpacity(255)
update_time:setColor(cc.c3b(30, 212, 30))
...
layout:setSize(cc.size(140, 27))

layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(231)
layout:setRightMargin(396)
layout:setTopMargin(57)
layout:setBottomMargin(471)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
Image_1:addChild(update_time)
