...
layout:setSize(cc.size(544, 500))
...
--Create Sprite_23
local Sprite_23 = cc.Sprite:create("combat_casting/res/22.png")
...
Button_1:setPosition(272, 156.16)
...
Text_1:setPosition(272, -17.5351)
Text_1:setScaleX(1)
Text_1:setScaleY(1)
...
Text_1_0:setPosition(98, 124.9649)
...
Btn_yulan:setPosition(457, 111.3099)
...
layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(387)
layout:setRightMargin(17)
layout:setTopMargin(355.6901)
layout:setBottomMargin(78.3099)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
bg:addChild(Btn_yulan)

--Create Sprite_5
local Sprite_5 = cc.Sprite:create("combat_casting/res/444.png")
...
Btn_receive:setPosition(457, 41.3099)
...
--Create weishangbang
local weishangbang = cc.Sprite:create("combat_casting/res/31.png")
...
--Create yilingqu
local yilingqu = cc.Sprite:create("combat_casting/res/yilingqu.png")
