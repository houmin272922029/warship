local AdvanceStarView = qy.class("AdvanceStarView", qy.tank.view.BaseView, "advance.ui.AdvanceStarView")
...
function AdvanceStarView:ctor(delegate, oldTankId)
    ...
    local item1 = require("advance.src.TankInfoList2").new(cc.size(470,635))
