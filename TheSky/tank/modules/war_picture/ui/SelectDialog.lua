...
Frame:setPosition(266.9995, 136.9999)
Frame:setScaleX(1)
...
layout:setBottomMargin(-30.5001)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
BG:addChild(Frame)
...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("Resources/common/img/06.png")
...
Sprite_1:setPosition(272.0008, 295.3818)
...
layout:setPositionPercentY(0.8817)
layout:setPercentWidthEnabled(false)
layout:setPercentHeightEnabled(false)
...
layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(84.0008)
layout:setRightMargin(86.9992)
layout:setTopMargin(18.1182)
layout:setBottomMargin(273.8818)
Sprite_1:setFlippedX(false)
Sprite_1:setFlippedY(false)
Frame:addChild(Sprite_1)
...
Image_3:setPosition(266.9998, 151.5498)
Image_3:setScaleX(1)
...
layout:setHorizontalEdge(0)
layout:setVerticalEdge(0)
layout:setLeftMargin(21.9998)
layout:setRightMargin(25.0002)
layout:setTopMargin(28.4502)
layout:setBottomMargin(56.5498)
layout:setStretchWidthEnabled(false)
layout:setStretchHeightEnabled(false)
BG:addChild(Image_3)
...
Text_1_0:setString([[提示：奖励越高，完成难度越大]])
...
Text_1_0:setPosition(138.5, 130)
...
layout:setPositionPercentXEnabled(false)
layout:setPositionPercentYEnabled(false)
layout:setPositionPercentX(0.2756)
layout:setPositionPercentY(0.16)
layout:setPercentWidthEnabled(false)
layout:setPercentHeightEnabled(false)
layout:setPercentWidth(0.1407)
...
Text_1_1:setPosition(264.5, 246)
...
layout:setPositionPercentY(0.8945)
layout:setPercentWidthEnabled(false)
layout:setPercentHeightEnabled(false)
layout:setPercentWidth(0)
layout:setPercentHeight(0)
