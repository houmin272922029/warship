...
local TankInfoList2 = qy.class("TankInfoList2", qy.tank.view.BaseView, "view/garage/TankInfoList2")
...
function TankInfoList2:render(entity, entity2)
    ...
    if entity and type(entity) == "table" then
        ...
        if entity.advance_level and entity.advance_level > 0 then
            ...
            self.tankName:setString(entity2.name)
        end
        ...
        h = h - 30
        for i=1,#data2 do
            local item = require("view/garage/InfoList").new(data[i], data2[i])
