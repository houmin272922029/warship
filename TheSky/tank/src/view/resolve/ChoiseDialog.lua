...
local ChoiseDialog = qy.class("ChoiseDialog", qy.tank.view.BaseDialog, "view/resolve/ChoiseDialog")
...
function ChoiseDialog:ctor(idx,delegate,refresh)
    ...
    self:OnClick("okBt",function()
        print("走了这里")
        if self.choose3 == 0 and self.choose2 == 0 and self.choose1 == 0 then
