...
local TimeLimitActivitiesItem = qy.class("TimeLimitActivitiesItem", qy.tank.view.BaseView, "view/operatingActivities/timeLimitActivities/TimeLimitActivitiesItem")

function TimeLimitActivitiesItem:ctor(delegate)
    TimeLimitActivitiesItem.super.ctor(self)
...
function TimeLimitActivitiesItem:onEnter()
...
function TimeLimitActivitiesItem:onExit()
	self:getEventDispatcher():removeEventListener(self.listener)
end

return TimeLimitActivitiesItem
