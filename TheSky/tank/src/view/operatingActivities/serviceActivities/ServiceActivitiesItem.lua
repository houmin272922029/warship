...
local ServiceActivitiesItem = qy.class("ServiceActivitiesItem", qy.tank.view.BaseView, "view/operatingActivities/serviceActivities/ServiceActivitiesItem")

function ServiceActivitiesItem:ctor(delegate)
    ServiceActivitiesItem.super.ctor(self)
...
function ServiceActivitiesItem:onEnter()
...
function ServiceActivitiesItem:onExit()
	self:getEventDispatcher():removeEventListener(self.listener)
end

return ServiceActivitiesItem
