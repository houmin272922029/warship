...
local AppstoreMonthCard = qy.class("AppstoreMonthCard", qy.tank.view.BaseDialog, "view/monthCard/AppstoreMonthCard")

local model = qy.tank.model.OperatingActivitiesModel
local service = qy.tank.service.OperatingActivitiesService
function AppstoreMonthCard:ctor(entity)
    model:monthCardInit()
    AppstoreMonthCard.super.ctor(self)
...
function AppstoreMonthCard:createReward()
    for i = 1, 2 do
...
function AppstoreMonthCard:update()
    for i = 1, 2 do
...
function AppstoreMonthCard:buyCard(idx)
...
function AppstoreMonthCard:onExit()
    -- cc.Director:getInstance():getTextureCache():removeAllTextures()
end

return AppstoreMonthCard
