...
local TankTip = qy.class("TankTip", qy.tank.view.BaseView, "view/tip/TankTip")
...
function TankTip:ctor(entity)
    ...
    local des = cc.Label:createWithTTF(entity.des or "",qy.res.FONT_NAME_2, 20.0,cc.size(560,0),0)
