...
function HowToPlayDialog:ctor(delegate)
    ...
    self.howToPlayDataArr = delegate.data
...
function HowToPlayDialog:createTableView(idx)
    ...
    local rollNum = 0
    local maxNum = #self.howToPlayDataArr
    ...
    local function tableCellAtIndex(table, idx)
        ...
        if nil == cell then
            ...
            local item  = qy.tank.view.campaign.HowToPlayItem.new(
                {
        ...
        cell.item:update(self.howToPlayDataArr[idx+1])
