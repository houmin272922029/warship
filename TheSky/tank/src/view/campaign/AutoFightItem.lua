...
function AutoFightItem:ctor(callBack, index , awards)
    ...
    self.item5:setVisible(false)
    self.item6:setVisible(false)
    self.item7:setVisible(false)
...
function AutoFightItem:setData(data)
    ...
    local isShowUserExp = true
    local index = 1
    if data.award and #data.award >= 3 then
        isShowUserExp = false
        index = 0
    end
