...
local BattleFieldStoreModel = qy.class("BattleFieldStoreModel", qy.tank.model.BaseModel)


local userinfoModel = qy.tank.model.UserInfoModel
local NumberUtil = qy.tank.utils.NumberUtil
function BattleFieldStoreModel:init(data)
	self.award_list = {}

	
	local staticData = qy.Config.battlefield_store 
...
function BattleFieldStoreModel:update(_data)
	local data = _data
...
function BattleFieldStoreModel:getRemainTime()
